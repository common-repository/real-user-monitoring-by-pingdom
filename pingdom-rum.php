...
(function() {
    ...
    p.async = 'async';
    p.src = '//rum-static.pingdom.net/pa-<?php echo $code; ?>.js';
...
?>
<div class="wrap">
    <img src="<?php echo plugin_dir_url("/", __FILE__) . trim(dirname(plugin_basename(__FILE__)), '/'); ?>/pingdom-logo.svg" alt="Pingdom logo" class="logo" />
    ...
    <p><?php _e('To get your ID, login at <a href="https://my.pingdom.com/">My Pingdom</a>, go to "RUM" and edit or create your check. In the url, copy the id:', 'pingdom-rum'); ?></p>
    <p><code>https://my.pingdom.com/3/visitor-insights/<span class='underline'>1a2b3c4e5f6a7b8c9d0e1f2a</span>/experience</code></p>
